...
app.use(helmet({
    contentSecurityPolicy: {
        directives: {
            ...
            connectSrc: ["'self'", "https://api.razorpay.com", "http://localhost:3000", "https://www.mailxpose.tech", "https://mailxpose.tech"], // Add production URLs
...
// Analyze email - POINT TO CENTRALIZED CONTROLLER
app.use(['/api/analysis', '/analysis', '/api/api/analysis'], analysisRoutes);
